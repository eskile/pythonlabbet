...
class EditorCanvasQuiz extends Component
{
    ...
    public $correct;
    public $solved = '';
    public $text = 'Läs koden nedan och försök lista ut vad programmet ritar. Kör programmet efter du svarat och se om du fick rätt.';
    ...
    {
        return view('livewire.editor-canvas-quiz');
    }
