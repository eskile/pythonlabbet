<div class="mb-4 {{ $solved ? 'bg-green-100' : 'bg-red-100' }} p-8">
    ...
    <div id="control-buttons-{{$editorId}}">
        <button type="button" id="run-{{$editorId}}" class="run-button border border-green-600 bg-green-600 text-white px-4 py-2 select-none hover:bg-green-700 focus:outline-none focus:ring">Kör och rätta</button>
